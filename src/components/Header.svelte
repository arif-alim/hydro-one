...
<header class="bg-white max-w-2xl mx-auto container px-15">
    <div class=" lg:divide-y lg:divide-gray-200 ">
        <div class="relative h-16 flex justify-between items-center">
            ...
            <div class="relative z-10 flex items-center lg:hidden">
                ...
                <button
                    type="button"
                    class="rounded-md p-2 inline-flex items-center justify-center text-gray-500  hover:text-hydroTeal focus:outline-none nav__toggler"
    ...
    {#if isOpen}
        <nav class="lg:hidden " aria-label="Global" id="mobile-menu">
            <div class="py-4  px-2 space-y-4 divide-y divide-gray-200">
                <div>
                    <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-900 hover:bg-gray-50 hover:text-gray-900" -->
                    <a
                        href="#"
